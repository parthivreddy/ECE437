...
add wave -noupdate -expand -group DUT /memory_control_tb/DUT1/core
add wave -noupdate -expand -group DUT /memory_control_tb/DUT1/ncore
...
WaveRestoreCursors {{Cursor 1} {22722 ps} 0}
